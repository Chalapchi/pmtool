    ...
    <div className="p-6 space-y-8 max-w-4xl">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded text-dark-100 focus:outline-none focus:ring-2 focus:ring-primary-500 min-h-[200px]"
        />
        ...
        <label className="flex items-center gap-2 mt-3 text-sm text-dark-300 cursor-pointer">
          <input
            ...
            className="w-4 h-4 rounded bg-dark-700 border-dark-500 text-primary-500 focus:ring-primary-500 focus:ring-offset-0"
          />

          ...
          return (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-2 bg-dark-900">
                ...
                {/* Add Task Button */}
                <button className="w-full flex items-center justify-center gap-2 p-3 border-2 border-dashed border-dark-600 rounded text-dark-400 hover:border-dark-500 hover:text-dark-300 transition-colors">
                  <Plus className="w-4 h-4" />
